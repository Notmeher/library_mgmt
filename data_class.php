...
class data extends db {
    ...
    function addbook($bookname, $bookdetail, $bookauthor, $bookpub, $branch, $bookprice, $bookquantity) {
       ...
       $q="INSERT INTO book (id,bookname, bookdetail, bookauthor, bookpub, branch, bookprice,bookquantity,bookava,bookrent)
           VALUES
           ('','$bookname', '$bookdetail', '$bookauthor', '$bookpub', '$branch', '$bookprice', '$bookquantity','$bookquantity',0)";
    ...
    function issuebook($book,$userselect,$days,$getdate,$returnDate){
        ...
        if ($result > 0) {
            ...
            $q="UPDATE book 
                SET bookava='$newbookava', bookrent='$newbookrent' 
                where id='$bookid'";
            if($this->connection->exec($q)){
