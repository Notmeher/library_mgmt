...
?>
        ...
        <div class="innerdiv">
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="ECE"/>ECE<div style="margin-left:80px"><input type="radio" name="branch" value="SBE"/>SBE<input type="radio" name="branch" value="Eng"/>Eng</div>
            </div>   
            <label>Price:</label><input  type="text" name="bookprice"/></br>
